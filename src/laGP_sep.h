...
void laGPsep(const unsigned int m, const unsigned int start, 
    ...
    double *df, double *dmle, int *dits, double *gmle, int *gits, 
    double *llik, int fromR);

void laGPsep_R(int *m_in, int *start_in, int *end_in, double *Xref_in, 
    int *nref_in, int *n_in, double *X_in, double *Z_in, double *d_in, 
    double *g_in, int *imethod_in, int *close_in, int *numrays_in, 
    double *rect_in, int *verb_in, int *Xiret_in, int *Xi_out, 
