/* 
 * This code has been copied from the C source of the CompQuadForm
 * package for R;
 *
 * Any changes specific to the laGP package are noted below and
 * are the responsibility of the authors of that package 
*/
 ...
 * davies:
 *
 * this function was added for the laGP package 
 * to vectorize calls to qfc above
 */
...
{
   int i;
   for(i=0; i<*lq; i++) qfc(lb1, nc1, n1, r1, sigma, c1+i, lim1, acc, trace+7*i, ifault+i, res+i);
