...
void aGP_R(int *m_in, int *start_in, int *end_in, double *XX_in, int *nn_in,
    ...
    int *numrays_in, double *rect_in, int *verb_in, int *Xiret_in, int *Xi_out, 
    double *mean_out, double *var_out, double *dmle_out, int *dits_out, 
    double *gmle_out, int *gits_out,  double *llik_out);
...
void laGP_R(int *m_in, int *start_in, int *end_in, double *Xref_in, int *nref_in,
         ...
         double *s2_out, double *df_out, double *dmle_out, int *dits_out, 
         double *gmle_out, int *gits_out, double *llik_out);
